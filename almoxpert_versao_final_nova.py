...
def get_sectors() -> list[sqlite3.Row]:
    db = get_db()
    return db.execute("SELECT * FROM sectors ORDER BY name ASC").fetchall()


def get_items() -> list[sqlite3.Row]:
    db = get_db()
    return db.execute("SELECT * FROM items ORDER BY item_name ASC").fetchall()
